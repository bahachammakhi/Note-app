        ...
        <div>
          <nav className="sidenav" className={this.state.openNav}>
            <div className="text-center">
              ...
              <a onClick={this.props.note} className="text-white mt-5">
                <i className="fas fa-clipboard mr-2" />Notes
              </a>
              <hr />
              <a onClick={this.props.todo} className="text-white">
                <i className="fas fa-list mr-2" />Tasks
              </a>

              <hr />
              <a onClick={this.props.signout} className="text-white">
